...
car1_x = 10;
car1_y = 10;
var audio = new Audio('car+running3.mp3');
audio.play();

car2_width = 120;
car2_height = 70; 
myAudio = new Audio('car+running3.mp3'); 
...
function right_car2()
{
	...
	function kaunhekarodpati(){
		if (car1_x>500){
			console.log("Car 1 Win!");
			document.getElementById("game_status").innerHTML = "Car1 Won Man!";
			JEETHASIL();
		}
		if (car2_x>500){
			console.log("Car 2 Win!");
			document.getElementById("game_status").innerHTML = "Car2 Won Man!";
			JEETHASIL();
		}
	}